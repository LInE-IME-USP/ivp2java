...
public class IVPMatrixReference extends Reference {
  ...
  public void setReferencedMatrix (String referencedMatrix) {
    ...
    IVPMatrix m = (IVPMatrix) Services.getModelMapping().get(referencedMatrixID);
  ...
  public String toXML () {
    Expression line = (Expression) Services.getModelMapping().get(lineExpID);
    Expression column = (Expression) Services.getModelMapping().get(columnExpID);
