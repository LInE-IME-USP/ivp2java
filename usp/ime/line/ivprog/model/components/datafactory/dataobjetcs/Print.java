...
public class Print extends CodeComponent {
  ...
  public String toXML () {
    Expression printable = (Expression) Services.getModelMapping().get(printableObjectID);
    String str = "<dataobject class=\"print\"><id>" + getUniqueID() + "</id>" + "<printable>" + printable.toXML()
            + "</printable></dataobject>";
    return str;
    }

  public String toJavaString () {
    Expression e = (Expression) Services.getModelMapping().get(printableObjectID);
