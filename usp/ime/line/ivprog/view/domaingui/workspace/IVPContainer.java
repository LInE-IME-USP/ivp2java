...
public class IVPContainer extends JPanel {
  ...
  public void removeChild (String childID) {
    JComponent child = (JComponent) Services.getViewMapping().get(childID);
  ...
  public void addChild (String childID) {
    JComponent child = Services.getRenderer().paint(childID);
    children.add(children.size() - 1, child);
    relayout();
    }

  public void childRemoved (String childID) {
    JComponent c = (JComponent) Services.getViewMapping().get(childID);
    children.remove(c);
    relayout();
    }
