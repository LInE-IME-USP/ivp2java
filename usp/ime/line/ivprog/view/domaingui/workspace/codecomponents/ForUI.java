...
public class ForUI extends CodeBaseUI implements ICodeListener {
  ...
  public ForUI (String id) {
    ...
    Services.getController().addComponentListener(this, id);
    }
  ...
  private void initFieldsAndLabels () {
    String index;
    index = ((For) Services.getModelMapping().get(getModelID())).getIndexExpression();
  ...
  private void initIndexField (String index) {
    ...
    indexField.setHolderContent(Services.getRenderer().paint(index));
  ...
  private void level3Action () {
    ...
    btnLvl3.setVisible(false);
    Services.getController().changeForMode(For.FOR_MODE_3, getModelID());
  ...
  private void level2Action () {
    ...
    Services.getController().changeForMode(For.FOR_MODE_2, getModelID());
  ...
  private void level1Action () {
    ...
    btnLvl2.setVisible(true);
    btnLvl3.setVisible(false);
    Services.getController().changeForMode(For.FOR_MODE_1, getModelID());
