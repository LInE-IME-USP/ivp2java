  ...
  public void initOperationSignMenu () {
    ...
    Action changeToAND = new AbstractAction () {
      public void actionPerformed(ActionEvent e) {
        Services.getController().changeExpressionSign(currentModelID, Expression.EXPRESSION_OPERATION_AND, context);
    ...
    Action changeToOR = new AbstractAction () {
      public void actionPerformed(ActionEvent e) {
        Services.getController().changeExpressionSign(currentModelID, Expression.EXPRESSION_OPERATION_OR, context);
    ...
    Action changeToLEQ = new AbstractAction () {
      public void actionPerformed(ActionEvent e) {
        Services.getController().changeExpressionSign(currentModelID, Expression.EXPRESSION_OPERATION_LEQ, context);
        Tracking.track("event=CLICK;where=BTN_EXPRESSION_OPERATION_LEQ;");
        }
      };
    // setConstantAction.putValue(Action.SMALL_ICON, new
    // ImageIcon(ExpressionBase.class.getResource("/usp/ime/line/resources/icons/varDelete2.png")));
    ...
    Action changeToLES = new AbstractAction () {
      public void actionPerformed(ActionEvent e) {
        Services.getController().changeExpressionSign(currentModelID, Expression.EXPRESSION_OPERATION_LES, context);
        Tracking.track("event=CLICK;where=BTN_EXPRESSION_OPERATION_LES;");
        }
      };
    // setConstantAction.putValue(Action.SMALL_ICON, new
    // ImageIcon(ExpressionBase.class.getResource("/usp/ime/line/resources/icons/varDelete2.png")));
    ...
    Action changeToEQU = new AbstractAction () {
      public void actionPerformed(ActionEvent e) {
        Services.getController().changeExpressionSign(currentModelID, Expression.EXPRESSION_OPERATION_EQU, context);
        Tracking.track("event=CLICK;where=BTN_EXPRESSION_OPERATION_EQU;");
        }
      };
    // setConstantAction.putValue(Action.SMALL_ICON, new
    // ImageIcon(ExpressionBase.class.getResource("/usp/ime/line/resources/icons/varDelete2.png")));
    ...
    Action changeToNEQ = new AbstractAction () {
      public void actionPerformed(ActionEvent e) {
        Services.getController().changeExpressionSign(currentModelID, Expression.EXPRESSION_OPERATION_NEQ, context);
        Tracking.track("event=CLICK;where=BTN_EXPRESSION_OPERATION_NEQ;");
        }
      };
    // setConstantAction.putValue(Action.SMALL_ICON, new
    // ImageIcon(ExpressionBase.class.getResource("/usp/ime/line/resources/icons/varDelete2.png")));
    ...
    Action changeToGEQ = new AbstractAction () {
      public void actionPerformed(ActionEvent e) {
        Services.getController().changeExpressionSign(currentModelID, Expression.EXPRESSION_OPERATION_GEQ, context);
        Tracking.track("event=CLICK;where=BTN_EXPRESSION_OPERATION_GEQ;");
        }
      };
    // setConstantAction.putValue(Action.SMALL_ICON, new
    // ImageIcon(ExpressionBase.class.getResource("/usp/ime/line/resources/icons/varDelete2.png")));
    ...
    Action changeToGRE = new AbstractAction () {
      public void actionPerformed(ActionEvent e) {
        Services.getController().changeExpressionSign(currentModelID, Expression.EXPRESSION_OPERATION_GRE, context);
        Tracking.track("event=CLICK;where=BTN_EXPRESSION_OPERATION_GRE;");
        }
      };
    // setConstantAction.putValue(Action.SMALL_ICON, new
    // ImageIcon(ExpressionBase.class.getResource("/usp/ime/line/resources/icons/varDelete2.png")));
