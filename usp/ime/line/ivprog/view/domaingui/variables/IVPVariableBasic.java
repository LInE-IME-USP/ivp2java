...
public class IVPVariableBasic extends RoundedJPanel implements IDomainObjectUI {
  ...
  private void initDeleteBtn () {
    Action action = new AbstractAction () {
      public void actionPerformed (ActionEvent e) {
        ...
        Services.getController().deleteVariable(modelScopeID, currentModelID);
        }
      };
  ...
  private void initValueContainer () {
    ...
    value.setValueListener(new IValueListener () {
      public void valueChanged (String value) {
        Services.getController().changeVariableInitialValue(currentModelID, value);
        }
      });
    add(value);
    }
  ...
  private void initName () {
    ...
    name.setValueListener(new IValueListener () {
      public void valueChanged (String value) {
        if (Services.getController().validateVariableName(modelScopeID, value)) {
          Services.getController().changeVariableName(currentModelID, value);
          }
        else {
          Variable v = (Variable) Services.getModelMapping().get(currentModelID);
          if (!v.getVariableName().equals(value)) {
            Services.getController().printError(ResourceBundleIVP.getString("Error.sameVariableName") + " " + value);
            }
          else {
            name.resetTextField();
            }
  ...
  private class ConfigTypeActionListener implements ActionListener {
    ...
    public void actionPerformed (ActionEvent e) {
      ...
      if (command.equals(ResourceBundleIVP.getString("IVPVariableBasic.config.integer"))) {
        Services.getController().changeVariableType(currentModelID, Expression.EXPRESSION_INTEGER);
        changeVariableType();
        ...
        Services.getController().changeVariableType(currentModelID, Expression.EXPRESSION_DOUBLE);
        changeVariableType();
        ...
        Services.getController().changeVariableType(currentModelID, Expression.EXPRESSION_STRING);
        changeVariableType();
        ...
        Services.getController().changeVariableType(currentModelID, Expression.EXPRESSION_BOOLEAN);
        changeVariableType();
  ...
  public void setModelID (String id) {
    currentModelID = id;
    variable = (Variable) Services.getModelMapping().get(id);
    changeVariableType();
    }
