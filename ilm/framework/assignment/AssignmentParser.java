...
final class AssignmentParser {
	...
	public String convertAssignmentToString(DomainConverter converter, Assignment assignment) {
		...
		if (assignment.getCurrentState().getList().size() > 0) {
			string += "<" + IlmProtocol.ASSIGNMENT_CURRENT_NODE + ">"
			        + converter.convertObjectToString(assignment.getCurrentState().getList()) + "</" + IlmProtocol.ASSIGNMENT_CURRENT_NODE
			        + ">";
		} else {
			string += "<" + IlmProtocol.ASSIGNMENT_CURRENT_NODE + "/>";
		}
		...
		string += "<" + IlmProtocol.CONFIG_LIST_NODE + ">" + convertMapToString(assignment.getConfig()) + "</"
		        + IlmProtocol.CONFIG_LIST_NODE + ">";
		string += "<" + IlmProtocol.METADATA_LIST_NODE + ">" + convertMapToString(assignment.getMetadata()) + "</"
	...
	public String createMetadataFileContent(Vector list, String config) {
		...
		string += "</" + IlmProtocol.FILE_LIST_NODE + "><" + IlmProtocol.CONFIG_LIST_NODE + ">" + config + "</"
		        + IlmProtocol.CONFIG_LIST_NODE + "><" + IlmProtocol.METADATA_LIST_NODE + ">";
