...
public abstract class DomainModel {
     ...
     * @return the percentage (grade) as the result of the comparison between the currentState, sent by the student, and the expected answer, defined by the teacher
     * 
     * @see example.ilm.model.IlmDomainModel
     */
    public abstract float AutomaticChecking(AssignmentState studentAnswer, AssignmentState expectedAnswer);
}
