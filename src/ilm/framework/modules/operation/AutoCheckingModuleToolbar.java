...
public class AutoCheckingModuleToolbar extends IlmModuleToolbar {
	...
	public AutoCheckingModuleToolbar(AutomaticCheckingModule module) {
		...
		button = makeButton("autochecking", "AUTOMATIC CHECKING", ResourceBundleIVP.getString("evaluationBtn.Tip"),
		        ResourceBundleIVP.getString("evaluationBtn.AltText"));
	...
	public void update(Observable arg0, Object arg1) {
		...
		/*
		 * if (_module.hasExpectedAnswer()) { button.setEnabled(true); } else {
