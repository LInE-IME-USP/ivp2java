...
/**
   ...
   * 
   * @param assignment : config
   * @param domainGUI
   * @param assignment : metadata It is called just after the construct method by the
   *  framework
   */
   ...
   * 
   * @param proposition
   * @param initial : assignment state
   * @param current : assignment state
   * @param expected : assignment answer It is called just after the construct method by the framework
   */
   ...
   *         field. It is called by BaseGUI when the button save assignment is pressed.
   */
