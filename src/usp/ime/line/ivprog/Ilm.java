...
public class Ilm extends JApplet implements IlmProtocol {
	...
	public void init() {
		...
		add(gui);
		String paramPropositionURL = "", // it is a string content of IVP or it
										 // is an URL of the content file
		paramPropositionIsURL = ""; // if "true" => 'paramPropositionSTR' it is
									// an URL with file address
