...
public class ConfigurationGUI extends JFrame {
  ...
  // Called by: usp.ime.line.ivprog.modules.configuration.ConfigurationToolBar.ConfigurationToolBar(): frame = new ConfigurationGUI();
  ...
  // Called by: usp.ime.line.ivprog.modules.configuration.ConfigurationGUI.ConfigurationGUI(): initLayoutAndPanel()
  // Initiated after: usp.ime.line.ivprog.Ilm.init(): ilmControl.initialize(true, args, new IlmSystemFactory());
