...
public class IVPContextMenu extends JPanel {
	...
	private void initWriteBtn() {
		...
		//writeBtn.setIcon(new ImageIcon(IVPContextMenu.class.getResource("/usp/ime/line/resources/icons/plus_btn_icon.png")));
	...
	private void initForBtn() {
		...
		//forBtn.setIcon(new ImageIcon(IVPContextMenu.class.getResource("/usp/ime/line/resources/icons/plus_btn_icon.png")));
	...
	private void initIfElseBtn() {
		...
		//ifElseBtn.setIcon(new ImageIcon(IVPContextMenu.class.getResource("/usp/ime/line/resources/icons/plus_btn_icon.png")));
